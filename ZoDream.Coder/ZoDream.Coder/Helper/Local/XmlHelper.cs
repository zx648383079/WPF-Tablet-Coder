...
namespace ZoDream.Coder.Helper.Local
{
    /// <summary>
    ...
    public class XmlHelper
    {
        ...
        /// <param name="innerText">节点文本值</param>
        /// <returns>成功返回true,失败返回false</returns>
        public static bool CreateXmlNodeByXPath(string xmlFileName, string xpath, string xmlNodeName,
            string innerText)
        {
            ...
            CodeItem item)
        {
            ...
            try
            {
                ...
                {
                    var subElement = xmlDoc.CreateElement(xmlNodeName);
                    subElement.AppendChild(GetElement(xmlDoc, "name", item.Name));
                    subElement.AppendChild(GetElement(xmlDoc, "description", item.Descroption));
                    subElement.AppendChild(GetElement(xmlDoc, "content", item.Content));
                    xmlNode.AppendChild(subElement);
                }
                xmlDoc.Save(xmlFileName); //保存到XML文档
            }
        ...
        private static XmlElement GetElement(XmlDocument xml, string name, string content)
        {
